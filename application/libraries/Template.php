...
class Template
{
    ...
    public $_app_name = 'Aplikasi CAT';
    //isikan detail tambahan aplikasi anda disini
    public $_app_slogan = 'Computer Assisted Test';
    //pemisah judul
    ...
    public function get_data_situs()
    {
        ...
        // Memeriksa apakah tabel "tbl_situs" ada dalam database
        if ($this->_ci->db->table_exists('tbl_situs')) {
            // Jika tabel ada, dapatkan baris pertama sebagai array
            return $this->_ci->db->get('tbl_situs')->row_array();
        }
    }
