...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="<?= site_url('admin/data-peserta-ujian-import') ?>" enctype="multipart/form-data">
                <div class="form-group row">
                    <label for="dtfile" class="col-sm-2 col-form-label">Download Template</label>
                    <div class="col-sm-10">
                        <a href="<?= site_url('template/pengguna.xlsx') ?>" class="btn btn-primary">Template Peserta Ujian (.xlsx)</a>
                    </div>
                </div>
                <div class="form-group row">
            ...
            <?php if (isset($_POST['btn-preview'])) : ?>
                ...
                <?php if ($status) : ?>
                    ...
                    <?= form_open('admin/data-peserta-ujian-do-import', null, ['data' => json_encode($import)]); ?>
